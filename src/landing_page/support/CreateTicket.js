  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4>
            <i className="fa fa-user-circle" aria-hidden="true"></i>Your
            Zerodha Opening
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4>
            <i className="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha
            Account
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4>
            <i className="fa fa-desktop"></i> Console
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4>
            <i className="fa fa-money"></i> coin
          </h4>
